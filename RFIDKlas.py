		...
		if (inCmd == "scan"):
			...
			while isScan:
				...
				if status == mfrc.MI_OK:
					...
					#print ("%2X%2X%2X%2X%2X"%(uid[0],uid[1],uid[2],uid[3],uid[4]))
					print (uid)
					if uid == c.uidcard1:
						print(c.uidcard1)
						print(c.content1)
					...
					if uid == c.uidcard2:
						...
						print(c.name2)
						import webbrowser
						webbrowser.open_new_tab(c.link2)
						time.sleep(10)
					if uid == c.uidcard3:
						print(c.uidcard3)
						print(c.content3)
						print(c.name3)
						import webbrowser
						webbrowser.open_new_tab(c.link3)
						time.sleep(10)
